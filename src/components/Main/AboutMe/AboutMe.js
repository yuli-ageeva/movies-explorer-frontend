    ...
    <section className='about-me'>
      ...
      <div className='about-me__info'>
        <div className='about-me__description'>
          ...
          <p className='about-me__description-info'>Я родилась в Нижнем Новгороде и закончила Юридический факультет
          ...
          <Link className='about-me__description-link' to="https://github.com/yuli-ageeva" target='_blank'>Github</Link>
        </div>
