      ...
      <main className='profile'>
        ...
        <form className='profile__form'>
          <label className='profile__info'>
            ...
            <input className='profile__info-input' id='name-input' type='text' name='name' placeholder='Имя' value='Юля'
                   required/>
          </label>
          <label className='profile__info'>
            <span className='profile__info-description'>E-mail</span>
            <input className='profile__info-input' id='email-input' type='email' name='email' value='pochta@yandex.ru'
                   required/>
          </label>
        </form>
